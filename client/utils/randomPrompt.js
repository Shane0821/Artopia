...
var allArrays = [prefixes, adjectives, colors, characters, styles, objects, elements, places, artists, improvers, suffixes];
...
export const generatePrompts = (minLength = 8, maxLength = 35) => {
  ...
  for (var i = 0; i < length; i++) {
    prompt += getRandomWord(allArrays[i % allArrays.length]);
    if (i + 1 !== length) {
